...
extension Notification.Name {
    ...
    static let openSpotlight = Notification.Name("TickTalk.openSpotlight")
    /// Posted by the menu-bar item to open Settings.
    static let openSettings = Notification.Name("TickTalk.openSettings")
}
...
/// Bundled brand assets (TickTalk "T-Burst"), copied into `Contents/Resources`
...
enum Brand {
    ...
    static let menuBar: NSImage? = {
        guard let image = bundled("TickTalk-menubar", "png") else { return nil }
...
@main
struct TickTalkApp: App {
    @NSApplicationDelegateAdaptor(AppDelegate.self) private var appDelegate

    var body: some Scene {
        WindowGroup("TickTalk") {
            RootSplitView()
        }
